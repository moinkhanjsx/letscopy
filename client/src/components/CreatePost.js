    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="card animate-fade-in">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Create New Copy</h1>
          <p className="text-gray-600 text-sm sm:text-base">Write your thoughts, notes, or reusable prompts</p>
        </div>
